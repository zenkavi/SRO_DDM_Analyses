...
```{r}
ez_t1_comp_metrics = find_optimal_components(clean_test_data_ez, fm = "minres", verbose = TRUE)



fm="minres"
data = clean_test_data_ez
cur_c = 3
out = psych::fa(data, 1, rotate='oblimin', fm=fm, scores='tenBerge')
out$BIC

tmp = get_demographics()

find_optimal_components(data, minc=1, maxc=5, fm="minres", verbose = T)
