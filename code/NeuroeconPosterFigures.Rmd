...
clean_test_data_std %>%
  ...
  mutate(task_group = ifelse(task_group=="adaptive_n_back", "Task 1", "Task 2"),
         facet_var = paste(rt_acc, task_group)) %>%
...
ggsave('t1_ddm_eg.jpeg', device = "jpeg", path = "../output/figures/", width = 10, height = 2, units = "in", limitsize = FALSE, dpi = 300)
```
...
ggsave('t2_ddm_eg.jpeg', device = "jpeg", path = "../output/figures/", width = 10, height = 2, units = "in", limitsize = FALSE, dpi = 300)
```