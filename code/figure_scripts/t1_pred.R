t1_ez_fa_t1_demog = read.csv('/Users/zeynepenkavi/Dropbox/PoldrackLab/SRO_DDM_Analyses/input/prediction/pred_out_ez_t1_fa_3_scores_demog_fa_scores_t1.csv')
...
t1_ez_mes_t1_demog = read.csv('/Users/zeynepenkavi/Dropbox/PoldrackLab/SRO_DDM_Analyses/input/prediction/pred_out_res_clean_test_data_ez_demog_fa_scores_t1.csv')
...
t1_raw_t1_demog = read.csv('/Users/zeynepenkavi/Dropbox/PoldrackLab/SRO_DDM_Analyses/input/prediction/pred_out_res_clean_test_data_raw_demog_fa_scores_t1.csv')
