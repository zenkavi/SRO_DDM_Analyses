...
if(dv_data = "ian_demog_scores" & iv_data %in% c('ez_t2_fa_3_scores', 'ez_t2_fa_3_pred_scores', 'ez_t2_522_fa_3_scores', 'ez_t2_522_fa_3_pred_scores', 'res_clean_retest_data_raw', 'res_clean_retest_data_ez')){
