...
For ~70% of the variance you'd need ~20 components. Given that there are 14 tasks is this a good decomposition? If you believe that each task measures multiple cognitive processes then maybe.
