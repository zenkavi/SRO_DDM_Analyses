...
DDM's are joint models of RTs and accuracy.
At each bound (correct vs incorrect) there is a distribution of RTs.
The drift rate is a summary statistic that should allow some trace to hit either bound closest to the mean of the RT distribution.
But where does this take in to account the trial-by-trial variability?