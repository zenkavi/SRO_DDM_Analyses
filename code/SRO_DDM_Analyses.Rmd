...
Raw and non-contrast measures have higher between subjects variance (ie are between individual difference measures)
...
Note: Not refitting HDDM's for each of these sample sizes since a. there were no differences in parameter stability for n=150 vs 552 and b. a more comprehensive comparison using non-hierarchical estimates and model fit indices will follow.
