...
To answer this question I used the T1 EFA model to predict the T2 data and extracted factor scores for all subjects for both time points.
...
ez_t2_fa_3_scores = data.frame(ez_t2_fa_3)
...
ez_fa_rel_df = make_rel_df(ez_t1_fa_3_scores, ez_t2_fa_3_scores, metrics = c("icc", "var_breakdown"))

ez_fa_rel_df
```

LOOK AT FACTOR SCORE SCATTER PLOT BETWEEN EZ_T1_FA_3 AND PREDICTED EZ_T2_FA_3
LOOK AT FACTOR LOADING SCATTER PLOT BETWEEN EZ_T1_FA_3 AND FITTED
EZ_T2_FA_3
